...
class Client(Iface):
    ...
    def recv_infer(self):
        ...
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "infer failed: unknown result")
...
class create_args:
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'spec', (lucidatypes.ttypes.QuerySpec,
                                   lucidatypes.ttypes.QuerySpec.thrift_spec), None, ),  # 2
    )
...
class learn_args:
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'LUCID', None, None, ),  # 1
        (2, TType.STRUCT, 'knowledge', (lucidatypes.ttypes.QuerySpec,
                                        lucidatypes.ttypes.QuerySpec.thrift_spec), None, ),  # 2
    )
...
class infer_args:
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'LUCID', None, None, ),  # 1
        (2, TType.STRUCT, 'query', (lucidatypes.ttypes.QuerySpec,
                                    lucidatypes.ttypes.QuerySpec.thrift_spec), None, ),  # 2
    )
